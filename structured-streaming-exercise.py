# -*- coding: utf-8 -*-
"""
Created on Wed Jan 27 10:05:17 2021
...
endpointCountsDF = logsDF2.groupBy(window(col("eventTime"), "30 seconds", "10 seconds"), col("endpoint")).count().orderBy('count', ascending=False)

# Kick off our streaming query, dumping results to the console
query = ( endpointCountsDF.writeStream.outputMode("complete").format("console").queryName("counts").start() )
